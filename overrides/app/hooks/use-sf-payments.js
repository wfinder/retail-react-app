...
// Cached server snapshot — React requires getServerSnapshot to return a stable reference.
const SERVER_STORE_SNAPSHOT = {sfp: null, confirmingBasket: null}
...
export const useSFPayments = () => {
    ...
    const globals = useSyncExternalStore(subscribe, () => store, () => SERVER_STORE_SNAPSHOT)
    const confirmingBasket = useSyncExternalStore(subscribe, () => store.confirmingBasket, () => null)
